...
function nuevaTabla(tabla, iteraccion, xl, f_xl, xu, f_xu, xr, f_xr, ea, precision) {
	...
	cols[1].innerHTML = xl.toPrecision(precision)*1;		//  Se ajusta los datos a un numero de cifras
